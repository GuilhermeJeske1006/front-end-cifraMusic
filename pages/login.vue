        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <form class="space-y-4 md:space-y-6" @submit.prevent="login" >
            ...
            <div class="flex items-center justify-between">
              ...
              <a :href="baseUrl + 'forgot-password'" class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Esqueci minha senha</a>
            </div>
            <button type="submit" class="w-full justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2">Entrar</button>
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              Você ainda não se registrou? <a :href="baseUrl + 'register'" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Criar conta</a>
            </p>
          </form>
        </div>
      </div>
